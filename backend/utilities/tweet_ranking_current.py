...
def generate_tweet_line(url: str) -> str:
    ...
    return f"🇮🇳 Indian Players in Latest {org} {category} Rankings 🇮🇳"
...
# urls = ["official-atp-doubles-ranking","official-atp-ranking","official-wta-ranking","official-wta-doubles-ranking"]
urls = ["official-atp-ranking","official-wta-ranking","official-wta-doubles-ranking"]
